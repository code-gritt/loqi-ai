  ...
  const testimonials = [
    {
      ...
      avatar: "SJ",
      rating: 5,
      text: "Loqi AIsaved me weeks of development time. The authentication system alone is worth the price. Highly recommended!",
      twitter: "@sarahj_dev",
    },
    {
      name: "Mike Chen",
    ...
    },
    {
      ...
      avatar: "DK",
      rating: 5,
      text: "Loqi AIhas become an essential part of our development workflow. The code quality is excellent and the documentation is comprehensive.",
    ...
    },
    {
      ...
      avatar: "LW",
      rating: 5,
      text: "The multi-tenancy support is exactly what we needed for our B2B platform. Loqi AImade complex features simple to implement.",
    ...
    },
    {
      ...
      avatar: "AT",
      rating: 5,
      text: "As a freelancer, time is money. Loqi AIhelps me deliver projects faster and take on more clients. Game changer!",
    ...
    },
    {
      ...
      avatar: "JW",
      rating: 5,
      text: "We've been using Loqi AIfor 6 months now. The support team is responsive and the updates keep getting better.",
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((t, idx) => (
            ...
            >
              ...
              <div className="text-sm text-pink font-medium">{t.twitter}</div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-pink to-blue-500 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              Start building faster with Loqi AItoday
            </p>
            <button
              onClick={() => {
