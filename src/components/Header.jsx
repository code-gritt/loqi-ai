      ...
      <div className="max-w-7xl mx-auto">
        <div className={`relative transition-all duration-500 ${
          ...
          <div className="flex-shrink-0 flex items-center space-x-3">
            ...
            <h1 className={`text-2xl font-bold font-sora transition-colors duration-500 ${isScrolled ? 'text-navy dark:text-dark-text' : 'text-navy dark:text-white'}`}>
              Larafast
            </h1>
          </div>
          ...
          <nav className="hidden md:flex space-x-8">
            <button
              ...
              className={`hover:text-pink transition-colors duration-200 font-medium ${isScrolled ? 'text-navy dark:text-dark-text' : 'text-navy dark:text-white'}`}
            >
              Home
            </button>
            <button
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className={`hover:text-pink focus:outline-none focus:text-pink transition-colors duration-200 ${isScrolled ? 'text-navy dark:text-dark-text' : 'text-navy dark:text-white'}`}
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4">
            <div className={`relative px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t rounded-b-2xl shadow-lg shadow-white/20 dark:shadow-pink/20 shadow-2xl overflow-hidden transition-all duration-500 ${
              ...
              <button
                onClick={() => scrollToSection('home')}
                className={`block px-3 py-2 hover:text-pink transition-colors duration-200 font-medium ${isScrolled ? 'text-navy dark:text-dark-text' : 'text-navy dark:text-white'}`}
              >
                Home
              </button>
              <button
