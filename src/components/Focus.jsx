  ...
  return (
    <section className="relative py-20 bg-white dark:bg-dark-bg overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 right-20 w-36 h-36 bg-blue-500/15 rounded-full blur-lg animate-bounce"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/3 w-24 h-24 bg-purple-500/15 rounded-full blur-2xl animate-pulse"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold text-navy dark:text-dark-text font-sora">
              Focus on your <span className="text-pink">Ideas</span>
            </h2>
            ...
            <p className="text-lg text-gray-700 dark:text-dark-text-secondary leading-relaxed font-medium">
              Stop wasting time on repetitive code. Loqi AI generates fully
              functional code snippets from your prompts, so you can concentrate
              on building unique features and solving real problems.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-gray-900 dark:bg-gray-900 rounded-2xl p-6 shadow-2xl dark:shadow-pink/20 dark:shadow-2xl">
              ...
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-gray-400 text-sm ml-4">LoqiAI.php</span>
              </div>

              {/* Code Content */}
              <div className="space-y-3 text-sm font-mono">
                <div className="text-blue-400">
                  <span className="text-gray-500">//</span> Generated by Loqi AI
                </div>
                <div className="text-gray-300">
                  <span className="text-purple-400">class</span>{" "}
                  <span className="text-yellow-400">FeatureBuilder</span>{" "}
                  <span className="text-gray-500">{"{"}</span>
                </div>
                <div className="text-gray-300 ml-4">
                  <span className="text-purple-400">public function</span>{" "}
                  <span className="text-yellow-400">generateFeature</span>
                  <span className="text-gray-500">()</span>
                </div>
                <div className="text-gray-300 ml-8 text-gray-500">{"{"}</div>
                <div className="text-gray-300 ml-12">
                  <span className="text-green-400">//</span> Your AI-generated
                  code here
                </div>
                <div className="text-gray-300 ml-12">
                  ...
                  <span className="text-gray-500">-&gt;</span>
                  <span className="text-yellow-400">createFeature</span>
                  <span className="text-gray-500">();</span>
                </div>
                <div className="text-gray-300 ml-8 text-gray-500">{"}"}</div>
              ...
              <div className="mt-4 p-3 bg-green-900/30 rounded-lg border border-green-500/30">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-green-400 text-xs font-mono">
                    Loqi AI generated successfully! 🚀
                  </span>
                </div>
              </div>
            </div>
